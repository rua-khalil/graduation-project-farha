...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  void _markAsRead(String id) {
    ...
    // await http.patch(Uri.parse('https://your-api.com/notifications/$id/read'));
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: kBg,
      appBar: const UserNav(activeTab: 'Notifications'),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Stay updated with bookings, reminders, and venue activity.',
              ...
              FarhaCard(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Important updates about your reservations and account actions.',
