import 'package:farha/UserDashboardPage.dart';
import 'package:farha/UserMessagespage.dart';
...
class UserNav extends StatefulWidget implements PreferredSizeWidget {
  final String activeTab;

  const UserNav({super.key, this.activeTab = 'Dashboard'});
  ...
  void _showAvatarMenu(BuildContext context) {
    ...
    showMenu<String>(
      ...
      items: [
        ...
        _buildMenuItem('bookings', Icons.calendar_month_outlined, 'My Bookings'),
        _buildMenuItem('favorites', Icons.favorite_border, 'Favorites'),
      ...
      switch (value) {
        case 'dashboard':
          Navigator.push(context, MaterialPageRoute(builder: (_) => const UserDashboardPage()));
          break;
        case 'bookings':
            ...
            child: Column(
              ...
              children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      _NavTab(label: 'Dashboard', icon: Icons.grid_view_rounded, isActive: activeTab == 'Dashboard', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const UserDashboardPage()))),
                      _NavTab(label: 'My Bookings', icon: Icons.calendar_month_outlined, isActive: activeTab == 'My Bookings', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const BookingHistoryPage()))),
                      _NavTab(label: 'Favorites', icon: Icons.favorite_border, isActive: activeTab == 'Favorites', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const FavoritesPage()))),
                      _NavTab(label: 'Messages', icon: Icons.chat_bubble_outline, isActive: activeTab == 'Messages', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const MessagesPage()))),
                      _NavTab(label: 'Notifications', icon: Icons.notifications_outlined, isActive: activeTab == 'Notifications', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const NotificationsPage()))),
                      _NavTab(label: 'Profile', icon: Icons.person_outline, isActive: activeTab == 'Profile', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ProfilePage()))),
                    ],
                  ),
                ),
              ],
